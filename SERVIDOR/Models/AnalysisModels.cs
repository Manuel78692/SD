// Shared models for analysis communication between SERVIDOR and ANALISERPC
// These models are duplicated to avoid cross-project dependencies
...
namespace ANALISERPC.Models
{
    ...
    public class AnaliseRequest
    {
        ...
        public string TipoAnalise { get; set; } = string.Empty; // "basica", "tendencia", "anomalia", "completa"
